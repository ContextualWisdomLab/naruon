...
# Only present on databases that predate the email_records rename; a fresh
# install has no "emails" table for CREATE INDEX to target. Identity-matched
# in execute_schema_backfill() below so it can be skipped instead of failing.
