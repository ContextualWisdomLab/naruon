...
from api.registration import registration_router
...
# Deliberately anonymous: signup happens before any session exists. The router
# fails closed (registration_unavailable) unless the relay is fully configured.
