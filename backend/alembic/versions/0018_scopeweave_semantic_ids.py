...
_TARGET_PRIMARY_KEY = "scopeweave_promotion_target_id"
_LINK_PRIMARY_KEY = "scopeweave_promotion_link_id"
...
def upgrade() -> None:
    ...
    op.alter_column(
        _TARGET_TABLE,
        "id",
        new_column_name=_TARGET_PRIMARY_KEY,
    ...
    op.alter_column(
        _LINK_TABLE,
        "id",
        new_column_name=_LINK_PRIMARY_KEY,
        existing_type=sa.Integer(),
        existing_nullable=False,
    )
