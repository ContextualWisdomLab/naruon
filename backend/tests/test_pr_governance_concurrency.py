...
def test_pr_governance_concurrency_expression_matches_workflow_contract() -> None:
    """Pin the exact PR-scoped grouping and synchronize-only cancellation policy."""
...
def test_pr_governance_concurrency_semantics_separate_only_superseded_pushes() -> None:
    """Model the workflow invariant across synchronize and recovery events."""
