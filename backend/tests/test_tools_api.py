...
@pytest.mark.parametrize("json_string", ["NaN", "Infinity", "-Infinity"])
@pytest.mark.asyncio
async def test_json_formatter_tool_rejects_non_standard_numeric_constants(
    json_string: str,
):
