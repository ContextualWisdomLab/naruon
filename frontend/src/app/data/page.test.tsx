...
describe("DataPage", () => {
  ...
  it("renders API-backed pipeline embedding and quality tabs", async () => {
    ...
    // Read this committed render once; do not reuse it after the next interaction.
    const qualityPanelText = container.textContent;
    expect(qualityPanelText).toContain("Thread id integrity");
    expect(qualityPanelText).toContain("Some scoped emails need canonical thread ids.");
    expect(qualityPanelText).toContain("Content segment text readiness");
    expect(qualityPanelText).toContain("Knowledge graph evidence endpoints");
    expect(qualityPanelText).toContain("paragraph segment evidence endpoints");
    expect(qualityPanelText).toContain("실사 스냅샷");
    expect(qualityPanelText).toContain("실사 스냅샷 JSON 복사");
    expect(qualityPanelText).toContain("raw 본문/첨부 원문 제외");
    expect(qualityPanelText).toContain("0123456789ab");
    expect(qualityPanelText).toContain("sha256");
    expect(qualityPanelText).toContain("Snapshot verification handoff");
    expect(qualityPanelText).toContain("python scripts/verify_evidence_snapshot.py <snapshot.json>");
    expect(qualityPanelText).toContain("file_path_or_stdin");
    expect(qualityPanelText).toContain("digest_mismatch");
    expect(qualityPanelText).toContain("4");
    expect(qualityPanelText).toContain("Buyer diligence packet checklist");
    expect(qualityPanelText).toContain("Privacy redaction policy");
    expect(qualityPanelText).toContain("Attachment parser manifest");
    expect(qualityPanelText).toContain("DOM paragraph topology");
    expect(qualityPanelText).toContain("Offline snapshot verification");
    expect(qualityPanelText).toContain("redacted_snapshot_policy");
    expect(qualityPanelText).toContain("buyer_evidence_readiness_gate");
    expect(qualityPanelText).toContain("Data room package manifest");
    expect(qualityPanelText).toContain("naruon-evidence-snapshot.json");
    expect(qualityPanelText).toContain("verify-evidence-snapshot.py");
    expect(qualityPanelText).toContain("knowledge-graph-evidence-samples.json");
    expect(qualityPanelText).toContain("acquisition-readiness-summary.json");
    expect(qualityPanelText).toContain("raw content: no");
    expect(qualityPanelText).toContain("stable IDs: no");
    expect(qualityPanelText).toContain("Diligence exception register");
    expect(qualityPanelText).toContain("critical");
    expect(qualityPanelText).toContain("quality_checks.thread_id_integrity");
    expect(qualityPanelText).toContain("blocks close: yes");
    expect(qualityPanelText).toContain("Semantic relation source backing");
    expect(qualityPanelText).toContain("semantic-relation-evidence-samples.json");
    expect(qualityPanelText).toContain("Diligence risk matrix");
    expect(qualityPanelText).toContain("Critical close blocker concentration");
    expect(qualityPanelText).toContain("2 critical exception(s)");
    expect(qualityPanelText).toContain("exception_repair_thread_id_integrity");
    expect(qualityPanelText).toContain("Diligence close decision summary");
    expect(qualityPanelText).toContain("close_blocked");
    expect(qualityPanelText).toContain("Close remains blocked");
    expect(qualityPanelText).toContain("6 proof requirement(s)");
    expect(qualityPanelText).toContain("5 required artifact(s)");
    expect(qualityPanelText).toContain("offline snapshot verifier");
    expect(qualityPanelText).toContain("Snapshot verification");
    expect(qualityPanelText).toContain("required");
    expect(qualityPanelText).toContain("Diligence close artifact review queue");
    expect(qualityPanelText).toContain("executive diligence reviewer");
    expect(qualityPanelText).toContain("data quality reviewer");
    expect(qualityPanelText).toContain("Proof counts");
    expect(qualityPanelText).toContain("total 2");
    expect(qualityPanelText).toContain("blocked 2");
    expect(qualityPanelText).toContain("attachment_parsing");
    expect(qualityPanelText).toContain("Diligence close owner handoff queue");
    expect(qualityPanelText).toContain("coverage reviewer");
    expect(qualityPanelText).toContain("Reviewer roles");
    expect(qualityPanelText).toContain("Handoff status");
    expect(qualityPanelText).toContain("assigned to attachment_parsing");
    expect(qualityPanelText).toContain("Diligence close traceability map");
    expect(qualityPanelText).toContain("acquisition_readiness_gate");
    expect(qualityPanelText).toContain("Trace keys");
    expect(qualityPanelText).toContain("review_acquisition_readiness_summary_json");
    expect(qualityPanelText).toContain("handoff_email_ingestion");
    expect(qualityPanelText).toContain("close proof traceability");
    expect(qualityPanelText).toContain("Diligence close proof plan");
    expect(qualityPanelText).toContain("critical evidence gate");
    expect(qualityPanelText).toContain("blocked");
    expect(qualityPanelText).toContain("All 2 exception(s)");
    expect(qualityPanelText).toContain("Regenerate the evidence snapshot");
    expect(qualityPanelText).toContain("verify_evidence_snapshot.py");
    expect(qualityPanelText).toContain("Proof artifact");
    expect(qualityPanelText).toContain("첨부 parser 형식별 현황");
    expect(qualityPanelText).toContain("application/octet-stream");
    expect(qualityPanelText).toContain("text/markdown");
    expect(qualityPanelText).toContain("application/pdf");
    expect(qualityPanelText).toContain("unsupported_content_type");
    expect(qualityPanelText).toContain("DOM/문단 구조별 현황");
    expect(qualityPanelText).toContain("KG edge 형식별 현황");
    expect(qualityPanelText).toContain("문단 근거 샘플");
    expect(qualityPanelText).toContain("KG 근거 샘플");
    expect(qualityPanelText).toContain("Semantic KG readiness");
    expect(qualityPanelText).toContain("Entity/relation extraction");
    expect(qualityPanelText).toContain("ready");
    expect(qualityPanelText).toContain("segment_citation");
    expect(qualityPanelText).toContain("Semantic relation evidence");
    expect(qualityPanelText).toContain("Vendor");
    expect(qualityPanelText).toContain("message_thread");
    expect(qualityPanelText).toContain("prepare_response_draft");
    expect(qualityPanelText).toContain("Buyer evidence readiness");
    expect(qualityPanelText).toContain("25%");
    expect(qualityPanelText).toContain("증거 패킷 생성됨");
    expect(qualityPanelText).toContain("Snapshot verification ready");
    expect(qualityPanelText).toContain("thread_id_integrity");
    expect(qualityPanelText).toContain("Acquisition decision summary");
    expect(qualityPanelText).toContain("Remediate acquisition evidence gaps before close.");
    expect(qualityPanelText).toContain("remediate_before_close");
    expect(qualityPanelText).toContain("Resolve critical and high remediation actions");
    expect(qualityPanelText).toContain("buyer_diligence_decision");
    expect(qualityPanelText).toContain("Acquisition KPI targets");
    expect(qualityPanelText).toContain("Thread id integrity target");
    expect(qualityPanelText).toContain("75% / 100%");
    expect(qualityPanelText).toContain("Semantic KG evidence target");
    expect(qualityPanelText).toContain("Semantic KG evidence must remain provenance-approved");
    expect(qualityPanelText).toContain("Remediation actions");
    expect(qualityPanelText).toContain("Canonical thread repair");
    expect(qualityPanelText).toContain("email_ingestion");
    expect(qualityPanelText).toContain("Run canonical threading repair");
    expect(qualityPanelText).toContain("Attachment parser coverage");
    expect(qualityPanelText).toContain("email_body");
    expect(qualityPanelText).toContain("paragraph");
    expect(qualityPanelText).toContain("node_has_segment");
    expect(qualityPanelText).toContain("/document[1]/paragraph[1]");
    expect(qualityPanelText).toContain("/document[1]/paragraph[1]/has/segment[1]");
    expect(qualityPanelText).toContain("문단 근거 연결됨");
    expect(qualityPanelText).toContain("의도만 기록");
    expect(qualityPanelText).not.toContain("provider_write_executed=false");
    expect(qualityPanelText).not.toContain("email_attachments.content_type");
    expect(qualityPanelText).not.toContain("content_segments.source_kind");
    expect(qualityPanelText).not.toContain("content_segments.safe_text_content");
    expect(qualityPanelText).not.toContain("content_segments.segment_path");
    expect(qualityPanelText).not.toContain("knowledge_graph_edges.source_kind");
    expect(qualityPanelText).not.toContain("knowledge_graph_edges.edge_kind");
    expect(qualityPanelText).not.toContain("knowledge_graph_edges.source_segment_id");
    expect(qualityPanelText).not.toContain("knowledge_graph_edges.edge_path");
    expect(qualityPanelText).not.toContain("sender_relationships.source_message_id");
    expect(qualityPanelText).not.toContain("segment_hidden_1");
    expect(qualityPanelText).not.toContain("edge_hidden_1");
    expect(qualityPanelText).not.toContain("relation_hidden_1");
    expect(qualityPanelText).not.toContain("snapshot_segment_hidden_1");
    expect(qualityPanelText).not.toContain("snapshot_edge_hidden_1");
    expect(qualityPanelText).not.toContain("snapshot_relation_hidden_1");
    expect(qualityPanelText).not.toContain("발견된 심각한 데이터 품질 문제가 없습니다.");
