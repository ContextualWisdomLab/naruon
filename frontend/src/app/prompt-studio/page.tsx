        ...
        <section className="flex flex-wrap items-start justify-between gap-4 border-b border-border pb-5">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button
              variant="outline"
              onClick={handleTest}
              disabled={testing || saving || !formData.content.trim()}
              aria-busy={testing || undefined}
              aria-label={testing ? '프롬프트 테스트 생성 중' : '실행 (Test)'}
        ...
        <section className="grid min-h-0 gap-5 xl:grid-cols-[18rem_minmax(0,1fr)_minmax(23rem,0.9fr)]">
          <Card className="h-fit">
            <CardHeader className="pb-3">
              ...
              <Input aria-label="템플릿 검색" placeholder="템플릿 검색..." type="search" />
            </CardHeader>
                ...
                <div>
                  <div className="mb-2 flex items-center justify-between gap-3">
                    ...
                    <Button
                      ...
                      disabled={testing || saving || !formData.content.trim()}
                      aria-busy={testing || undefined}
                      aria-label={testing ? '결과 다시 생성 중' : '다시 생성'}
                    >
