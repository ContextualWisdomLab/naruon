                  ...
                  <div className="flex min-w-0 flex-col gap-2 md:items-end">
                    ...
                    <div className="flex flex-wrap items-center gap-2 text-xs font-bold">
                      ...
                      <button
                        ...
                        className="inline-flex items-center justify-center gap-1.5 rounded-md bg-primary px-3 py-1.5 text-primary-foreground hover:bg-primary/90 disabled:cursor-not-allowed disabled:bg-secondary disabled:text-muted-foreground"
                      >
                        {confirmSubmitting && <Loader2 className="size-4 animate-spin" aria-hidden="true" />}
                        ...
                        <div className="mt-4 space-y-4">
                          ...
                          <div className="rounded-lg border border-border bg-card p-3">
                            ...
                            <button
                              ...
                              className="mt-3 inline-flex min-h-9 w-full items-center justify-center gap-1.5 rounded-md bg-primary px-3 text-xs font-bold text-primary-foreground hover:bg-primary/90 disabled:cursor-not-allowed disabled:bg-secondary disabled:text-muted-foreground"
                            >
                              {correctionSubmitting && <Loader2 className="size-4 animate-spin" aria-hidden="true" />}
