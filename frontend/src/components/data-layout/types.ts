...
export type CommercialCloseBuyerReviewRunbookStatus = 'review_ready' | 'review_blocked';
export type CommercialCloseBuyerReviewStepStatus = 'ready' | 'blocked';
export type CommercialCloseBuyerReviewStepLane = 'intake' | 'verification' | 'privacy' | 'data_room' | 'commercial' | 'signoff' | 'release';
...
export type DataEvidenceSnapshotResponse = {
  ...
  commercial_close_buyer_review_runbook: {
    ...
    blocker_key_count: number;
    blocked_step_keys: string[];
    blocker_keys: string[];
    first_step_key: string;
    final_decision_step_key: string;
    verification_command: string;
    buyer_handoff_text: string;
    next_action_text: string;
    steps: Array<{
