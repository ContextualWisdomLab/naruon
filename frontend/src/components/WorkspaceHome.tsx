          ...
          >
            <div className="p-3 border-b border-border bg-card">
              <button type="button"
                ...
                className="text-sm font-semibold text-primary flex items-center gap-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40 rounded-sm"
              >
                ← 목록으로
              </button>
            </div>
