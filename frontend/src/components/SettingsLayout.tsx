                ...
                <div className="grid gap-6 md:grid-cols-2">
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <button type="submit" disabled={commercialModelSaving || modelProvidersLoading} aria-busy={commercialModelSaving || modelProvidersLoading} title={commercialModelSaving || modelProvidersLoading ? "상용 모델 등록 중입니다" : undefined} className="inline-flex min-h-10 w-full items-center justify-center gap-2 rounded-lg bg-foreground px-4 py-2 text-sm font-bold text-background transition-colors hover:bg-foreground/90 disabled:cursor-not-allowed disabled:opacity-60">
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <button type="submit" disabled={localModelSaving || modelProvidersLoading} aria-busy={localModelSaving || modelProvidersLoading} title={localModelSaving || modelProvidersLoading ? "로컬 모델 등록 중입니다" : undefined} className="inline-flex min-h-10 w-full items-center justify-center gap-2 rounded-lg border border-border bg-background px-4 py-2 text-sm font-bold text-foreground transition-colors hover:bg-secondary disabled:cursor-not-allowed disabled:opacity-60">
                ...
                <div className="rounded-2xl border border-border bg-card p-6 shadow-sm space-y-4">
                  ...
                  <div className="grid gap-4">
                    ...
                    <button
                      ...
                      aria-busy={embeddingSaving} title={!selectedEmbeddingProvider ? "임베딩 모델을 선택해주세요" : embeddingSaving ? "임베딩 모델 저장 중입니다" : undefined}
