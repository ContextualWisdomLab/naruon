...
export function CalendarMonthView({ visibleMonthEvents }: Props) {
  ...
  // ⚡ Bolt: Wrap calendar grid generation in useMemo to prevent O(N) re-renders
  // 🎯 Why: Mapping over 35 calendar cells with nested events blocks the main thread during unrelated component updates.
