    ...
    <div className="flex h-full flex-col bg-card">
      <div className="flex items-start bg-gradient-to-br from-card via-card to-primary/5 p-6">
        ...
        <div className="mt-4 flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
          <div className="flex items-center gap-2 rounded-lg border border-border bg-background px-3 py-2 text-xs text-foreground shadow-sm shrink-0">
            <span aria-hidden="true">📎</span> Q2_Plan_Draft.pdf
          </div>
          <div className="flex items-center gap-2 rounded-lg border border-border bg-background px-3 py-2 text-xs text-foreground shadow-sm shrink-0">
            <span aria-hidden="true">📎</span> budget_v2.xlsx
          </div>
        </div>
      </div>
      <Separator />
