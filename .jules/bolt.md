...
## 2025-02-13 - Memoized NetworkGraph component
...
**Action:** Always wrap heavy, DOM-manipulating third-party visualization components in `React.memo` unless they explicitly require re-renders on every parent render cycle.
