...
## 2025-02-13 - Memoizing NetworkGraph without measurable impact rejected

**Learning:** Adding React.memo() to components like `NetworkGraph` without demonstrating a measurable performance impact is not worth the review and CI cost, and will be rejected.
**Action:** Do not apply micro-optimizations like `React.memo()` unless there is a proven, significant, and measurable benefit to the application's performance.
