## [Unreleased]
- Storybook now inventories the shared Button and Badge states with the existing production CSS tokens. The [ADR-0013 decision](docs/adr/0013-storybook-design-system.md) records the Figma source and the exact CI verification commands for maintainers.
