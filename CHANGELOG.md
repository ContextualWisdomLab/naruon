## [Unreleased]
- Tenant archive import now sanitizes email, attachment, and task display text
  before persistence and rejects duplicate message/task identities before any
  write, preventing forged bundles from reaching unique constraints or storing
  active markup.
