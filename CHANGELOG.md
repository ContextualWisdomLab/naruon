## [Unreleased]
- Mail detail now exposes scoped CC/BCC, attachment metadata, and meeting-proposal evidence with a truthful link to the calendar workspace; provider writeback remains an explicit calendar action.
