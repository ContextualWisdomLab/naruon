...
- URL 인코더(`url_encoder`) 도구를 추가하여 입력된 텍스트를 URL 퍼센트 인코딩할 수 있게 하였습니다.
- URL 디코더(`url_decoder`) 도구를 추가하여 URL 인코딩된 텍스트를 디코딩할 수 있게 하였습니다.
- SHA-256 해시 생성기(`sha256_generator`) 도구를 추가하여 입력된 텍스트의 SHA-256 해시값을 생성할 수 있게 하였습니다.
