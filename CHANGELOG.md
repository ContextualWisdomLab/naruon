## [Unreleased]
- 프론트엔드 작업 상태 변경과 함께 되돌아온 loopback/HTTPS URL 보안 경계를 복구했습니다. 명시적 `:0`·범위 밖·비정상 포트는 scheme 기본값으로 치환하지 않고 거부하며, 45개 회귀 테스트·RFC 3986/6335 doctoring 문서와 Strix governance 재트리거를 유지합니다.
