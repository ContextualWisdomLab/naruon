...
### 도구 추가 (Tool Additions)

- URL 추출기(`url_extractor`) 도구를 추가하여 텍스트 본문에서 모든 URL을 추출할 수 있게 되었습니다.
- 해시 생성기(`hash_generator`) 도구를 추가하여 텍스트를 다양한 해시 알고리즘(MD5, SHA1, SHA256, SHA512)으로 변환할 수 있게 되었습니다.
