## [Unreleased]
- 새로운 해시 생성기(Hash Generator) 도구를 추가하여 텍스트를 MD5, SHA-256, SHA-512, BLAKE2b 등의 보안 해시 알고리즘을 사용해 변환할 수 있도록 지원합니다. 관련 API 테스트(test_execute_hash_generator)도 성공적으로 추가 및 검증되었습니다.
