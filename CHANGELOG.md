## [Unreleased]
- 추가: `backend/api/tools.py`에 단어 수를 기반으로 읽기 소요 시간을 예측하는 `time_spent_estimator` (읽기 소요 시간 예측기) 도구를 구현하고 등록했습니다.
- 수정: `api/tools.py` 내 분기점 테스트 코드를 추가하여 100% 테스트 커버리지를 달성했습니다.
