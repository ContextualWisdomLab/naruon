...
- Exact branch verification: Ruff passed, the combined provenance service/API suite passed 151 tests, the repaired bootstrap PostgreSQL smoke passed in isolation, and the full backend suite passed 1,971 tests with 3 skipped. All Python runs promoted warnings to errors.
