...
- [x] **Step 2: Add model and grouping helper**
...
- [x] **Step 3: Add deterministic labels and keys**
...
- [x] **Step 4: Include matrix in digest**
...
- [x] **Step 2: Render matrix entries**
...
- Plan committed in `eb286b9d`.
- Backend risk matrix contract, digest inclusion, and regression coverage committed in `f3a56c09`.
- Frontend risk matrix rendering and copied JSON coverage committed in `74ef2df4`.
- FigJam flowchart: https://www.figma.com/board/8otZ8A6PBCcDinhMzrD6dx
- Validation:
