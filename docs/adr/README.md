...
| [ADR-0005](0005-kg-extraction-orchestrator-free-pool-pin.md) | Route KG extraction through contextual-orchestrator without Naruon choosing the pool/model itself; fails closed until contextual-orchestrator ships a released consumer contract (Revision 7) | Proposed | Target `PLANNED`; runtime `BLOCKED-UPSTREAM` (0 contextual-orchestrator releases as of 2026-09-03) |
