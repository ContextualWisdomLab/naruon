...
| [ADR-0005](0005-kg-extraction-orchestrator-free-pool-pin.md) | Pin orchestrator-routed KG extraction to the fixed `orchestrator/free` pool id, never a passthrough provider model | Accepted | `ACCEPTED-NARUON-POLICY`; KG-extraction orchestrator path only |
