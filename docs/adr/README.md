...
| [ADR-0006](0006-bounded-deferred-attachment-recognition.md) | Recognize HWP/HWPX at a bounded deferred-parser boundary and retain valid source bytes up to 64 MiB | Accepted | `ACCEPTED-NARUON-POLICY`; no inline conversion or semantic extraction |
