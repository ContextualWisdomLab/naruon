...
| [ADR-0005](0005-product-technical-gap-baseline.md) | Keep one evidence-backed product/technical gap register and deliver it through the protected current-head loop | Accepted | Roadmap and merge evidence must remain source-backed; no runtime capability is implied |
