...
| [ADR-0023](0023-bounded-attachment-parse-source-contract.md) | Retain bounded attachment parse sources up to 64MiB without assuming a larger provider transport | Proposed | Naruon retention candidate; provider acceptance remains `BLOCKED-UPSTREAM` by immutable NewsDOM release/pin |
