...
| [ADR-0006](0006-noema-bounded-context-separation.md) | Naruon's Noema and `.github`'s CI-review Noema are separate Bounded Contexts that share only a name, not a code core | Accepted | `ACCEPTED-NARUON-POLICY`; no dependency on `.github`'s review scripts |
