...
| [ADR-0005](0005-signed-noema-gateway-settings.md) | Configure the scoped Noema gateway through a signed, audited, token-masking API | Proposed | Product setup path for the contextual-orchestrator runtime slice |
