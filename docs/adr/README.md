...
| [ADR-0005](0005-attachment-parser-boundary.md) | Fail closed for unsupported attachment formats and bounded deferred parsing | Accepted | `ACCEPTED-NARUON-POLICY`; parser coverage is measurable |
