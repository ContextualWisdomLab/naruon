...
| [ADR-0006](0006-noema-consumer-boundary.md) | Consume Noema and model orchestration only through released owner contracts | Proposed | Target `PLANNED`; no owner release or Naruon adoption proven |
