...
| [ADR-0006](0006-noema-bounded-context-separation.md) | **Superseded on arrival 2026-09-02** — original text wrongly concluded permanent separation; `docs/CWL-MASTER-CONTEXT.md` establishes Noema as one shared agent runtime (`.github` review + naruon + wardnet SOC + quarantine sandbox) by design. Read the correction at the top of the file before citing this ADR. | Superseded | Do not treat as settled architecture; shared-runtime design is open follow-up work |
