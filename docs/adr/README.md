...
| [ADR-0005](0005-lineageweave-calendar-projection-provider.md) | Publish a separately authenticated, fail-closed calendar observation contract for LineageWeave | Accepted | Provider contract implemented; inbound provider projection remains unavailable |
