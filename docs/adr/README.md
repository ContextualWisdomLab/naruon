...
| [ADR-0008](0008-auditable-data-hygiene-tools.md) | Bound URL evidence and contact redaction to explicit, auditable classes | Accepted | Deterministic tool contract; not general anonymization |
