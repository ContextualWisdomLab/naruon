...
## 4. UI Localization Catalog — v2.59 material contract
...
16. predecessor workflow/review receipts do not transfer. Exact `ad091f7b...` requires current full-suite/coverage/security and qualifying independent post-last-push review before policy acceptance.
