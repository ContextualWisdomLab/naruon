...
| #1427 | bounded PDF DOM upload | Draft head `3a5f2b37…` non-force consumes #1468 at `60391459…`, completing the `#1565 → #1468 → #1427` prerequisite chain; the effective six-file delta keeps signed-session, PDF signature, bounded-read, deferred-worker, ADR, and doctoring contracts, with four focused PDF tests plus 28 parent bootstrap/pin tests passing and one service-dependent test skipped; fresh exact-head hosted evidence remains required |
