...
v2.98 remains audit-visible as blob `74e6cf3bfbf048a7b16dc92882b1b4f8b7acea0d`; v2.97 as `13d4d7c2c871d17e9dcbf85d58ecbd180b9be5db`; v2.96 as `2286b315a7d7152254aebc466f327da300561755`; v2.95 as `8bd1c3d8a057b4b8eea4f94880e4c3e0302bb632`; v2.94 as `e4643a58abf613bba9a2bec90964ad7d9b908ae8`; v2.93 as `c72cc29a647ffca6ffcd891755a9abc6c2a17553`; v2.92 as `40b6875cc84f58cf340df4215af2b62e6db19944`; v2.91 as `9fe2b4930c27cdb089e32105840ce194e2fa5e7c`; v2.88 as `1c708286ddcd3c8ab543043aac428889b4f53c4f`. Attempted v2.89, v2.90 and the first v2.91 workflow currentizers remain transition-failure provenance only. The durable ledger is maintained by ordinary commits on the sole Gap-writer branch; self-modifying currentizers are not accepted as completion evidence.
...
The transition has now separated three defects from the candidate bytes. Run `35957638723` proved remote-head equality, exact staging and local commit, then failed while the old helper attempted workflow-file self-mutation. Ordinary-forward `4e5f8609f627c7d1bd24bf148fa11682ae67e503` removed that defect and introduced a product-only adopter. Run `35977315662` then reached candidate verification: artifact digest checks passed, `uv lock --check` passed, and the combined hash-locked core+agent installation passed with `httpx2==2.13.0`, `httpcore2==2.13.0`, and AnyIO `4.14.2`. It failed only in `backend/tests/test_container_dependency_pin_contract.py` with `AssertionError: orphaned SHA-256 hash in requirements lock`.

That failure was a test parser defect, not resolver incoherence. `_EXACT_PIN_PATTERN` recognized only `package==version`; the agent lock legitimately begins with `pydantic-ai-slim[openai]==2.9.0`, so its hash continuation was misclassified as orphaned. Ordinary-forward exact `2a87cb99205d29c04db188d4ddc0a44795bb1553` expands the regression parser to accept optional PEP 508 extras while normalizing records to the base package and adds a focused extras-bearing hash-lock regression. It changes no dependency bytes or gate policy. Fresh product-only adopter run `36001401538` and normal exact-head PR workflows were generated and remain queued/nonterminal at this observation. No helper-free 2.13.0 product child is accepted yet; Security remains RED and predecessor receipts do not transfer.
